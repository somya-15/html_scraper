...
console.log(playername); // Output: Cleric 3 (Domain of Peace)

const race = $("#race").text();
console.log(playername); // Output: Dragonborn (Red Dragon Ancestry)

const background = $("#background").text();
console.log(playername); // Output: Hermit
